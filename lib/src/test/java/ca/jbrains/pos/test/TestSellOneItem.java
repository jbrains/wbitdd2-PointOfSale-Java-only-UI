...
public class TestSellOneItem {
    ...
    @Test
    void priceFound() {
        String response = PointOfSale.handleBarcode(Barcode.makeBarcode("99999").get(), priceFoundCatalog, createDoNothingPurchaseProvider());
    ...
    void addItemToBasketWhenProductIsFound() {
        ...
        PointOfSale.handleBarcode(Barcode.makeBarcode("::any barcode::").get(), priceFoundCatalog, purchaseProvider);
