...
public class TestSellOneItem {
    ...
    void priceNotFound() {
        Assertions.assertEquals(
                ...
                PointOfSale.findProductPrice("99999", (ignored) -> null)
        );
    }
    ...
    void givenBarcodeIs1111ShouldDisplayProductNotFoundMessage() {
        Assertions.assertEquals(
                ...
                PointOfSale.findProductPrice("1111", (ignored) -> null)
        );
    }
    ...
    void priceFound() {
        Assertions.assertEquals(
                "CAD 1.00",
                PointOfSale.findProductPrice("99999", (ignored) -> "CAD 1.00")
        );
    }
    ...
    void givenEmptyBarcodeShouldReturnScanningErrorMessage() {
        Assertions.assertEquals(
                ...
                PointOfSale.findProductPrice("", (ignored) -> null)
        );
    }
