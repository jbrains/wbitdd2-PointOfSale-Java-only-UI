...
public class TestSellOneItem {
    ...
    @Test
    void priceNotFound() {
        String response = PointOfSale.handleSellOneItemRequest(new Barcode("99999"), null, CatalogFactory.notFoundCatalog());
    ...
    void givenBarcodeIs1111ShouldDisplayProductNotFoundMessage() {
        String response = PointOfSale.handleSellOneItemRequest(Barcode.makeBarcode("1111").get(), null, CatalogFactory.notFoundCatalog());
    ...
    @Test
    void priceFound() {
        String response = PointOfSale.handleSellOneItemRequest(Barcode.makeBarcode("99999").get(), new DoNothingBasket(), CatalogFactory.catalogWithPrice(100));
    ...
    void addItemToBasketWhenProductIsFound() {
        ...
        PointOfSale.handleSellOneItemRequest(Barcode.makeBarcode("::any barcode::").get(), basket, CatalogFactory.catalogWithPrice(100));
