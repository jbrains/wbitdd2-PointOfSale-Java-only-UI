...
public class TestSellOneItem {
    ...
    @Test
    void priceNotFound() {
        String response = PointOfSale.handleSellOneItemRequest(new Barcode("99999"), CatalogFactory.priceNotFoundCatalog(), null);
    ...
    @Test
    void priceFound() {
        String response = PointOfSale.handleSellOneItemRequest(Barcode.makeBarcode("99999").get(), CatalogFactory.catalogWithPrice(100), new DoNothingBasket());
    ...
    void addItemToBasketWhenProductIsFound() {
        ...
        PointOfSale.handleSellOneItemRequest(Barcode.makeBarcode("::any barcode::").get(), CatalogFactory.catalogWithPrice(100), basket);
