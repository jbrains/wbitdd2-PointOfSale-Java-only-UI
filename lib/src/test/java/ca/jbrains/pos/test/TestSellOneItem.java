...
public class TestSellOneItem {
    ...
    @Test
    void priceNotFound() {
        String response = PointOfSale.handleSellOneItemRequest(barcode -> Option.none(), null, new Barcode("99999"));
    ...
    void givenBarcodeIs1111ShouldDisplayProductNotFoundMessage() {
        String response = PointOfSale.handleSellOneItemRequest(barcode -> Option.none(), null, Barcode.makeBarcode("1111").get());
    ...
    @Test
    void priceFound() {
        String response = PointOfSale.handleSellOneItemRequest(barcode -> Option.of(100), new DoNothingBasket(), Barcode.makeBarcode("99999").get());
    ...
    void addItemToBasketWhenProductIsFound() {
        ...
        PointOfSale.handleSellOneItemRequest(ignored -> Option.some(100), basket, Barcode.makeBarcode("::any barcode::").get());
